...
useEffect(()=>{ 
  ...
  return (<>
   ...
   <div className='relative text-xl hover:text-orange-700'><p className='absolute bottom-0 right-10 lg:right:40'><Link href='/search'><FontAwesomeIcon icon={faMagnifyingGlass} /></Link></p></div> 
