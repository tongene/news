...
/>   
 ...
 <Link href='/naija-wiki/'><p className='py-3 font-bold text-center'>Netflix News</p></Link>  
  ...
  <div className='hidden lg:block mx-1 py-4 w-80'>  
   ...
   <Link href='/new-on-netflix/'><li className='hover:text-gray-400 dark:text-gray-200 list-none'>New on Netflix Naija</li></Link>
  <FontAwesomeIcon icon={faAngleRight}/>
    ...
    <Link href='/coming-to-netflix/'><li className='hover:text-gray-400 dark:text-gray-200 list-none'>Coming to Netflix Naija</li></Link>
  <FontAwesomeIcon icon={faAngleRight}/>
  </div> 
 ...
 <Link href={`/netflix-naija/${xy.slug}/`}><h2 className='overflow-hidden text-ellipsis text-base hover:text-gray-400 text-gray-600 dark:text-gray-200'style={{ display: '-webkit-box', WebkitLineClamp:3, WebkitBoxOrient: 'vertical' }}>{xy.title} </h2></Link>
  </div> 
 </div> 
 )}</div>
 ...
 <div className='bg-white px-3 dark:bg-black text-gray-800 dark:text-gray-200 py-8'> 
  ...
  <div className='flex' style={{width:'1000px'}}> 
   {next_posts.slice(0,3).map((xy,i)=> 
    ...
    <Link href={`/coming-to-netflix/${xy.node.slug}/`}><h2 className="hover:text-gray-700 text-base font-bold overflow-hidden text-ellipsis hover:text-gray-500 cursor-pointer"style={{ display: '-webkit-box', WebkitLineClamp:2, WebkitBoxOrient: 'vertical' }}>{xy.node.title}</h2></Link>            
